...
<p>Nível 5: <strong><a href="#tc=reflexao_de_eclipse">Reflexão de Eclipse</a></strong> — Libera a magia Reflexão de Eclipse (nível 1), que permite criar uma duplicata temporária para distração.</p>
